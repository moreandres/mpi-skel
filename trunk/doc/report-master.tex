...
\begin{enumerate}
\item Estudio de Multiplicación de Matrices. Reporte Técnico. Realizado como parte del curso {\it Fundamentos de Procesamiento Paralelo} dictado por el Dr {\it Marcelo Naiouf} \cite{mm-tool}.
...
\item OptimizationSection, Seccion sobre Optimización.

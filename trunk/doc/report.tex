...
Una forma de confirmar si el compilador esta vectorizando los ciclos de c\'omputo
intensivo es utilizar las opciones provistas para ello. Esto es muy \'util para
detectar si los cuellos de botella ya se encuentran optimizados o no.

Por ejemplo en el caso de que el c\'odigo se recursivo se detalla lo siguiente:

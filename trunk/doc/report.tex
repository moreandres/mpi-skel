...
% TBD: review wikipedia about this and get inspired
...
% TBD: insert nice chart here with the activities as a loop iterated over small changes
...
% TBD: why benchmarks are useful to analyze the performance of one application? baseline, characterization, limits, expected values

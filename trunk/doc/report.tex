...
El siguiente código ejemplifica como obtener un número de segundos en un punto flotante de doble precisión.
...
En kernel más viejos que 2.6, {\tt oprofile} \footnote{\tt http://oprofile.sourceforge.net} sino {\tt perf} \footnote{\tt https://perf.wiki.kernel.org}. Al estar implementados a nivel de núcleo, estos evitan las llamadas al sistema y tienen una sobrecarga de un orden de magnitud menor que los profilers a nivel de aplicación.
...
El sistema utilizado es el mismo para todos los casos de prueba. A continuación se muestra su configuración de hardware y software (Tabla \ref{table:testbed}), además del resultado del rendimiento según HPCC con un proceso por core disponible.
...
Diferentes alternativas de implementación esta operación son demostradas en \cite{mm-tool}, la 
...
Se utiliza una grilla donde cada celda transfiere calor a sus vecinos \footnote{\href{http://www.rblasch.org/studies/cs580/pa5/\#Source+Code-N100AC}{http://www.rblasch.org/studies/cs580/pa5/\#Source+Code-N100AC}.}.
...
Al realizar ejecuciones variando la cantidad de threads se obtuvieron los siguientes resultados (Figura \ref{fig:heat-threads}). Calculamos entonces la proporción serial y paralela, 20\% y 80\% respectivamente. Los límites son entonces: Amdalah $ X $ x y Gustafson $ Y $ x.
...
\begin{verbatim}
97.64% queens queens [.] solve(int, int, unsigned long, unsigned long, unsigned long)

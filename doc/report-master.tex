...
{\tt hotspot} es una aplicación escrita en Python localizada en:\\ \href{github.com/moreandres/bottleneck}{https://github.com/moreandres/hotspot}.
Se utiliza {\it GNU Plot} para la generación de gráficos y {\it GNU Scientific Library} para cálculos estadísticos. {\it Latex} se utiliza para la generación del reporte final.

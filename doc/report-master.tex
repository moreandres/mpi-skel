...
Este trabajo revisa la construcción de una infraestructura que simplifica el análisis de rendimiento; incluyendo casos de estudio con aplicaciones del mundo real como etapa de validación. El objetivo es simplificar la tarea evitando la ejecución de datos relevantes de modo manual, permitiendo más tiempo de experimentación y análisis.

\bigskip

Este trabajo contribuye entonces con un generador automático de reporte de rendimiento para aplicaciones de cómputo de altas prestaciones utilizando tecnología {\it OpenMP} sobre sistemas {\it GNU/Linux}.
...
\begin{enumerate}
\item Dado el procedimiento propuesto anteriormente, automatizarlo y analizar potenciales mejoras hacia generalidad y eficacia.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|}\hline
      {\bf Herramienta} & {\bf Ejemplo} & {\bf Descripción} \\ \hline
      Profiler & Software {\tt gprof} & Muestra información de perfil de llamadas a funciones \\ \hline
      Profiler & Hardware {\tt perf} & Muestra información de perfil de sistema \\ \hline
      Benchmark & {\it STREAM} & Benchmark de jerarquía de memoria \\ \hline
      Benchmark & HPL & Benchmark de capacidad de cómputo \\ \hline
      Benchmark & IMB Ping Pong & Benchmark de latencia y ancho de banda de red \\ \hline
      Benchmark & HPCC & Paquete de benchmarks \\ \hline
    \end{tabular}
    \label{table:tools}
\end{table}
...
{\tt bottleneck} es una aplicación escrita en C localizada en \href{github.com/moreandres/bottleneck}{github.com/moreandres/bottleneck}.
Se utiiliza {\it GNU Plot} para la generación de gráfico y {\it GNU Scientific Library} para cálculos estadísticos. {\it Latex} se utiliza para la generación del reporte final.
Se depende de GCC, GNU Make, prof, gprof para obtener información relevante.
...
Se detecta cuantas unidades de procesamiento hay en el sistema. Se utiliza una y luego se itera hasta utilizar todas, se ejecuta múltiples veces la aplicación y se promedia el resultado. Se sobrepone una curva ideal suponiendo {\it speedup} ideal.
Se sobrepone también la información más vieja disponible como mecanismo de validación de las optimizaciones.
...
\begin{enumerate}
\item clase1, descripción, responsabilidad
\item clase2, descripción, responsabilidad
\item clase3, descripción, responsabilidad
\end{enumerate}
...
Es utilizado por estudiantes de ingeniería electrónica para el calculo de distribución de radiación de una antena.

\href{bla}{https://code.google.com/p/nec2c/}

Partes relevantes del reporte.

\section{IUA Solver Elementos Finitos}

Elementos Finitos. Sacco. Utilizado para simular la resistencia del viento en aeronáutica.

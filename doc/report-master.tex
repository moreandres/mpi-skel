...
La propuesta principal consiste en el desarrollo de una infraestructura de soporte para el análisis de aplicaciones de cómputo de altas prestaciones ({\it HPC}, por las siglas en inglés de {\it High Performance Computing}). Este trabajo se realiza como extensión al trabajo final {\it Herramientas para el Soporte de Análisis de Rendimiento} de la Especialización en Cómputo de Altas Prestaciones y Tecnología Grid.
...
\item Articulo {\it Optimizing Latency in Beowulf Clusters}. HPC Latam 2012 \cite{latency}.
...
\begin{enumerate}
\item Dado una propuesta de procedimiento sistemático de análisis de rendimiento, automatizarlo y analizar potenciales mejoras de utilidad.
...
En el caso de tener un $ 95\% $ de paralelismo, la mejora no puede ser mayor a $ 20x $ la original.
...
Los siguientes requerimientos son los necesarios para una infrastructura:
...
La aplicación de las herramientas debe ser configurable en su totalidad mediante un archivo de configuración, evitando tareas manuales y repetitivas donde usualmente se comenten errores que causan pérdidas de tiempo valiosas.
...
La infrastructura debe ser implementada con un lenguaje portable, de ser posible basado en scripts de código abierto de forma que puedan ser revisado fácilmente por los usuarios para incluir nuevas fuentes de información o cambiar la forma en que las herramientas base son utilizadas.

\subsection{Extensibilidad}

La infrastructura debe poseer un diseño de fácil extensión, la incorporación de nuevas herramientas, gráficos o secciones dentro de un reporte debe ser una tarea trivial asumiendo que ya se conoce la forma de obtener la información requerida para ello.
...
\begin{enumerate}
\item Singleton, Patrón de Instancia Única, Es utilizado por otras clases para garantizar que solo existe una instancia única.
\item Tags, Almacenamiento de Palabras Clave, Es utilizado para guardar palabras clave que son utilizadas para generar el reporte.
\item Log, Generador de Mensajes, Es utilizado para estructurar los mensajes durante la ejecución.
\item Config, Administración de la Configuracion, Es utilizado para consultar la configuración de cada programación.
\item Section, Sección de Reporte, Es utilizado como base de otras secciones.
\item HardwareSection, Sección sobre {\it Hardware}, Es utilizado para obtener información del {\it hardware} disponible.
\item ProgramSection, Sección sobre el Programa, Es utilizado para obtener información del programa a analizar.
\item SoftwareSection, Sección sobre {\it Software}, Es utilizado para obtener información del {\it software} disponible.
\item SanitySection, Chequeo Base, Es utilizado para comprobaciones básicas del programa.
\item BenchmarkSection, Pruebas de Rendimiento, Es utilizada para obtener información de rendimiento.
\item WorkloadSection, Caso de Prueba, Es utilizada para obtener información del caso de prueba.
\item ScalingSection, Escalamiento de Problema, Es utilizada para entender como escala el tamaño del problema.
\item ThreadsSection, Seccion sobre Hilos, Es utilizada para entender como escalan los hilos.
\item OptimizationSection, Seccion sobre Optimización, Es utilizada para entender como responde el programa antes los diferentes niveles de optimización del compilador.
\item ProfileSection, Sección sobre el Perfil de Rendimiento, Permite entender en que partes del programa se invierte el tiempo de ejecución.
\item ResourcesSection, Uso de Recursos, Permite entender como se utilizan los recursos del sistema.
\item AnnotatedSection, Código Anotado, 
\item VectorizationSection, Información de Vectorización.
\item CountersSection, Información de Contador de {\it Hardware}.
\item ConfigSection, Configuración.
\end{enumerate}
...
\item Inclusión de una explicación breve de para que sirve la sección y los gráficos incluídos.
...
\subsection{Capacidad del Sistema}

Se incluyen detalles sobre la configuración de hardware y software del sistema.
Además se incluye información de rendimiento de referencia obtenida de la prueba de rendimiento HPCC.

\subsection{Carga de Trabajo}

Información sobre realizada.
...
\subsection{Bajo Nivel}

Registros de hardware. Contadores.

\subsection{Referencias}

Lista de publicaciones referenciadas anteriormente.
...
El reporte generado en bruto puede consultarse en el apéndice \ref{examples}.
...
Ejemplos de los reportes generados pueden consultarse en el apéndice \ref{examples}.

...
Linpack es un conjunto de subrutinas {\it Fortran} que resuelven ecuaciones
lineales y problemas relacionados como la multiplicaci\'on de matrices.

\cite{hpl}

HPL es una versi\'on portable del benchmark Linpack para sistemas de memoria
distribu\'ida. El paquete de software utiliza la librer\'ia MPI para
comunicaci\'on entre los nodos de c\'omputo con memoria distribu\'ida.
...
vez ya que asegura resultados reproducibles.
...
leyes de amdalah \cite{amdahl}, gustafson \cite{gustafson} y karp-flatt
\cite{karp-flatt}.
...
\bibitem{papi}
  ...
  \emph{Performance Application Programming Interface}, {\tt http://icl.cs.utk.edu/papi}.

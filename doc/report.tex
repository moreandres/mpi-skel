...
en el dominio. Este hecho resulta en menos tiempo para an\'alisis de resultados
...
capacidad de c\'omputo; aumentando la complejidad de implementaci\'on y
optimizaci\'on a\'un m\'as \cite{parallel-programming}.
...
esfuerzos de optimizaci\'on. Incluso es frecuente la implementacion {\em ad-hoc}
...
estad\'isticas mostradas por el Top500 \footnote{Ranking de supercomputadoras
...
GNU/Linux, denominados sistemas Beowulf \cite{beowulf}, son los m\'as utilizados.

\bigskip

Este trabajo resume tambi\'en la experiencia que debe realizar cualquier
individuo en busca de las diferentes alternativas para el an\'alisis de
rendimiento. Incluyendo la selecci\'on y prueba de herramientas de soporte y la
...
a nivel de hardware, pasando por soporte del n\'ucleo del sistema operativo hasta
monitores del uso de los recursos disponibles en el sistema durante la ejecuci\'on.
...
El resto del documento explica teor\'ia aplicada de an\'alisis de rendimiento
y temas relacionados. El cap\'itulo 2 discute el an\'alisis de rendimiento, sus
...
archivos temporales e incluso el ancho de red utilizado.
...
de altas prestaciones, y posteriormente sus detalles espec\'ificos y ejemplos
de sus reportes de salida.
...
utilizando sobre la jerarqu\'ia local de memoria.
...
{\em TBD: insert historic TOP500}

\bigskip

Este benchmark requiere cierto conocimiento para una correcta configuracion,
de modo de utilizar los recursos del sistema mejor. Por ejemplo el tama\~no de
bloque que se va a utilizar para la distribucion de trabajo depende del cache
del procesador y puede afectar notablemente la performance del sistema.

{\em TBD: insert HPL chart with different NBs}
...
Este benchmark es uno de los mas utilizados por su simpleza, muy utilizado
para comprobar que los dispositivos de red esten configurados en modo de baja
latencia. Debe ejecutarse en todos los links de un cluster o sistema.
...
de calculo de una supercomputadora, pero luego se determin\'o que la mejor

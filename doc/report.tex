...
complejidad hace posible su correcta implementaci\'on solo por los mismos investigadores.
...
esfuerzos de optimizaci\'on. Incluso es frecuente la implementaci\'on directa
...
monitores del uso de los recursos disponibles en el sistema durante la ejecuci\'on, hasta la
utilizaci\'on directa de tiempo de ejecuci\'on de una aplicaci\'on de referencia.
...
ejemplificada a trav\'es de diversas herramientas utilizando procedimientos sistem\'aticos.

...
Este cap\'itulo introduce el concepto de rendimiento y teor\'ia b\'asica sobre
...
operaciones en memoria. A continuaci\'on se resume las operaciones ejercitadas.
...
m\'as importantes del estandar para librer\'ias de paso de mensajes (MPI) \cite{mpi}.
...
Una taxonom\'ia interesante para entender como el benchmark se relaciona a diferentes n\'ucleos de c\'omputo
...
del problema a resolver, o la definici\'on de los resultados para ejercitar por m\'as tiempo y tener un resultado m\'as predecible.
...
$ T = S + \frac{P }{ p} $ donde T = tiempo de ejecuci\'on, S = trabajo serial, P = trabajo paralelizable, p = unidades de c\'omputo

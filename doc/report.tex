...
puede obtener, también nos permite esbozar algunas hipótesis \ref{table:testbed}
\ref{table:pruebas}.
...
existe abundante material sobre el tema. Diferentes alternativas de implementación son demostradas en
